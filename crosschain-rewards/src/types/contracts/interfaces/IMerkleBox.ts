...
export interface IMerkleBoxInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "Rewards"
      | "addReward"
...
export interface IMerkleBox extends BaseContract {
  connect(runner?: ContractRunner | null): IMerkleBox;
  waitForDeployment(): Promise<this>;

  interface: IMerkleBoxInterface;
